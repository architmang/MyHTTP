...
/*
	...
	MyOwnBrowser
*/
// GET http://localhost/Lec5.pdf
// PUT http://localhost/ Lec5.pdf
...
void openDocument(char *fileName)
{
    ...
    else if (strcmp(extension, ".jpeg") == 0 || strcmp(extension, ".jpg") == 0 || strcmp(extension, ".png") == 0 || strcmp(extension, ".gif") == 0 || strcmp(extension, ".bmp") == 0)
    {
